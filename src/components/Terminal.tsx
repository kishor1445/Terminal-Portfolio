...
const Terminal: React.FC<TerminalProps> = ({ isMobileDevice }) => {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                const projectRes = await axios.get("https://api.kishorramanan.com/data/projects")
                setProjects(projectRes.data["projects"]);

                const experienceRes = await axios.get("https://api.kishorramanan.com/data/experience")
                setExperience(experienceRes.data["experiences"])

                const certificatesRes = await axios.get("https://api.kishorramanan.com/data/certificates")
